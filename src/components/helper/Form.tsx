    ...
    emailjs
      .send(
        ...
        process.env.NEXT_PUBLIC_TEMPLATE_ID || "",
        {
          ...
          to_name: "Rishav",
          from_email: email,
          to_email: "rishavkamboj75@gmail.com",
          message: body,
        },
          ...
          <div className="flex flex-col space-y-4">
            ...
            >
              ...
              <span className="text-neutral-300 text-sm">
                <a href="https://github.com/RishavK1" target="_blank">
                  GitHub
                </a>
              </span>
              <BottomGradient />
            ...
            >
              ...
              <span className="text-neutral-300 text-sm">
                <a href="https://x.com/rishavkamboj75" target="_blank">
                  X &#40;Formerly Twitter&#41;
                </a>
              </span>
              <BottomGradient />
            ...
            >
              ...
              <span className="text-neutral-300 text-sm">
                <a
                  href="https://www.linkedin.com/in/rishavkamboj-dev/"
                  target="_blank"
                >
                  LinkedIn
                </a>
